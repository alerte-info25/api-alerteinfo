...
class EngagementNationalModel extends Model
{
    use SoftDeletes;
    protected $table = 'engagement_national_models';
    protected $fillable = [
        'uuid',
    ...
    {
        return $this->hasMany(EngagementNationalDataModel::class,'engagement_code_unique','engagement_code_unique');
    }
